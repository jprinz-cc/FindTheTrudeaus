$(document).ready(function () {
    ...
    function togglePiece(e) {
        ...
        if (this.id.indexOf('yeti') != -1) {
            ...
            this.setAttribute('style', 'background-image:url(\'./images/trump.png\'); background-repeat:no-repeat; background-size:contain; background-position:center;');

            //Audio trigger for yeti
            var yetiGrowl = new Audio('./media/youreFired.wav');
            yetiGrowl.play();
            ...
            var pieceID = this.id;
            var bgImgPath = './images/trudeau_' + pieceID.slice(7, 8) + '.png';
            ...
            var penguinSquawk = new Audio('./media/sacre.wav');
            penguinSquawk.play();
